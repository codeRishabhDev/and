...
// import { NotificationListener, requestUserPermission } from './src/notificationConfiguration'
...
// #8 Send Notification to React Native App using Firebase Cloud Messaging
...
const App = () => {
  const requestUserPermission = async () => {
    /**
     * On iOS, messaging permission must be requested by the current
     * application before messages can be received or sent
     */
